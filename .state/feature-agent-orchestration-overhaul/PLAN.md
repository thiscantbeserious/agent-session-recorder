...
- [ ] Create `agents/agents/architect.md` with frontmatter (Read/Grep/Glob/Write/Bash tools, disallowed Edit/NotebookEdit/WebFetch/WebSearch, maxTurns 40) and body (mindset, design process, cross-consultation guidance, input/output, key rules)
